...
exports.makeMCRCourseApp = makeMCRCourseApp;
...
var _ReactApp = require("./ReactApp");
...
function makeMCRCourseApp({
  ...
  function render(ui) {
    ...
    if (options.concurrentMode) {
      ...
      const root = (_reactDom.default.unstable_createRoot || _reactDom.default.createRoot)(rootEl);
      ...
      _reactDom.default.render(ui, rootEl);

      unmount = () => _reactDom.default.unmountComponentAtNode(rootEl);
    }
  }
