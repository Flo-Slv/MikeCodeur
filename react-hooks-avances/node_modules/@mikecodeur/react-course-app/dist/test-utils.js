...
exports.robertAlertTip = robertAlertTip;

var _chalk = _interopRequireDefault(require("chalk"));

var _react = require("@testing-library/react");

function robertAlertTip(shouldThrow, tip, {
  displayEl
} = {}) {
  let caughtError;
  ...
  const error = new Error(_chalk.default.red(`🚨 ${tipString}`)); // get rid of the stack to avoid the noisy codeframe
